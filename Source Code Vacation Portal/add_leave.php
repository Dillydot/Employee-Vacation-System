...
if(isset($_POST['submit'])){
    ...
    echo "Mail Sent. Thank you " . $name . ", The administrator will contact you shortly.";
	die();
}
?>
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Vacation Submission</strong><small> Form</small></div>
                        <div class="card-body card-block">
                           <form method="post">
						   
								<div class="form-group">
									<label class=" form-control-label">Vacation type</label>
