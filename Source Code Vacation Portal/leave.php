            ...
            <div class="orders">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="box-title">Vacation Requests </h4>
						    <?php if($_SESSION['ROLE']==2){ ?>
						   <h4 class="box_title_link"><a href="add_leave.php">Add Vacation Request</a> </h4>
						   <?php } ?>
                        </div>
                        <div class="card-body--">
									...
									<tr>
									   ...
									   <td>
										  ...
										  ?>
										   ...
										   <?php
										$to = "aggelzah@gmail.com";
                                        $subject = "Leave Request Status";
                                        $txt = "“Dear employee, your supervisor has".$row['leave_status']. " your application
										submitted on: $date";
